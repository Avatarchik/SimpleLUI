        ...
        public override void OnInspectorGUI()
        {
            ...
            _target.Items = JEMBetterEditor.ContentList(_target.Items, _target, o =>
            {
                ...
                o.obj = JEMBetterEditor.ContentList(o.obj, _target, s =>
                {
                    ...
                    return s;
                }, new BetterEditorStyle("Objects", $"{nameof(SLUIUnityEventHelperEditor)}.Obj_{_target.Items.IndexOf(o)}") { FoldoutHeaderType = BetterEditorHeaderType.None });
                ...
                EditorGUILayout.Space();
                return o;
            }, new BetterEditorStyle("Events", $"{nameof(SLUIUnityEventHelperEditor)}.Events"){FoldoutHeaderType = BetterEditorHeaderType.None});
