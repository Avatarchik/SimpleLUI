...
namespace SimpleLUI.API.Core
{
    ...
    public sealed class SLUIRectTransform : SLUIComponent
    {
        ...
        /// <inheritdoc />
        public override Type ResolveObjectType() => typeof(RectTransform);
        ...
        public override void CollectObjectProperty(Object obj)
        {
            ...
            // transform
            if (System.Math.Abs(t.pivot.x - 0.5f) > float.Epsilon || System.Math.Abs(t.pivot.y - 0.5f) > float.Epsilon)
