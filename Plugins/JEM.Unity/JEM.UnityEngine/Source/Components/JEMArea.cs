...
namespace JEM.UnityEngine.Components
{
    ...
    public enum JEMAreaMode
    {
        ...
        /// <summary>
        ///     The point will be generated using hit mask (random point from the highest Y of BoxCollider bounds).
        /// </summary>
        HitMask
    }
    ...
    /// </summary>
    [AddComponentMenu("JEM/Level/JEM Area")]
    ...
    public class JEMArea : MonoBehaviour
    {
        ...
        private void OnDrawGizmos()
        {
            ...
            switch (Mode)
            {
                case JEMAreaMode.Space:
                    ...
                    Gizmos.DrawCube(_collider.center, BoxSize);
                    break;
        ...
        /// </summary>
        /// <param name="point"/>
        public void GenerateReliablePoint(out Vector3 point) => GenerateReliablePoint(out point, out _);
        ...
        public bool GenerateUnreliablePoint(out Vector3 point, JEMAreaMode customMode = JEMAreaMode.Unknown) =>
        ...
        /// <summary>
        ///     Gets random Area from active scene.
        /// </summary>
        public static JEMArea GetRandomArea()
        {
            var spawnAreas = FindObjectsOfType<JEMArea>();
            if (spawnAreas.Length == 0)
                throw new InvalidOperationException("System was unable to get JEMArea. " +
                                                    "There is no JEMAreas defined in current world.");
