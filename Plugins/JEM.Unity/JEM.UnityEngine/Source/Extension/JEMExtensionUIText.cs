...
namespace JEM.UnityEngine.Extension
{
    ...
    /// </summary>
    public static class JEMExtensionUIText
    {
        /// <summary>
        ...
        public static void InsertText([NotNull] this Text text, [NotNull] string textToInsert, float speed) => InsertText(text, textToInsert, speed, null);
        ...
        internal static void RegenerateLocalScript()
        {
            ...
            if (_script == null)
                throw new NullReferenceException(
                    $"System was unable to regenerate local script of {nameof(JEMExtensionUIText)}@{nameof(JEMExtensionTextScript)}");
        }
