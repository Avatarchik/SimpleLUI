...
namespace JEM.UnityEngine
{
    ...
    public static class JEMTexture2D
    {
        ...
        /// </summary>
        public static string JEMTextureFileExtension = ".jte";

        /// <summary>
        ///     Converts this texture2D in to sprite.
        /// </summary>
        /// <exception cref="ArgumentNullException"/>
        public static Sprite ToSprite([NotNull] this Texture2D texture2D) => JEMSprite.FromTexture2D(texture2D);     
        ...
        ///     NOTE: Received bytes always contains data bout texture Width, Height, Format at the beginning of array.
        ///     To get raw texture byte data just call .GetRawTextureData() method on your texture.
        /// </summary>
        /// <exception cref="ArgumentNullException"/>
        ...
        /// </summary>
        /// <exception cref="ArgumentNullException"/>
        public static void WriteToFile([NotNull] string file, [NotNull] Texture2D texture) => File.WriteAllBytes(file, ToBytes(texture));
        
        /// <summary>
        ///     Reads Texture2D from file.
        /// </summary>
        /// <exception cref="ArgumentNullException"/>
        public static Texture2D ReadFromFile([NotNull] string file)
        {
